	...
	{	
		...
		public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
		{
			...
			using (new GUILayout.VerticalScope(EditorStyles.helpBox))
			{
				...
				//------------------------------ DISABLE HIDE TILING -------------------------------
				if (terrain != null && terrain.materialTemplate != null && terrain.materialTemplate.IsKeywordEnabled("_TERRAIN_DISTANCEBLEND"))
				{
					using (new GUILayout.VerticalScope(EditorStyles.helpBox))
					{
				...
				if (terrain != null && terrain.materialTemplate != null && targetMat.shader.name != InTerra_Data.DiffuseObjectShaderName && terrain.materialTemplate.IsKeywordEnabled("_TERRAIN_PARALLAX"))
				{
					using (new GUILayout.VerticalScope(EditorStyles.helpBox))
					{
