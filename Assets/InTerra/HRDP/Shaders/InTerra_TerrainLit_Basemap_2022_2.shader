//NOTE! This file is based on Unity file "TerrainLit_Basemap.shader" which was used as a template for adding all the InTerra features.
Shader "Hidden/InTerra/HDRP/TerrainLit_Basemap_2022_2"
{
    Properties
    {
        ...
        _Triplanar_MetallicAO("Metallic AO (RGB)", 2D) = "white" {}
   ...
   SubShader
    {
        PackageRequirements { "com.unity.render-pipelines.high-definition":"[14.0.0,14.99.99]" }
        ...
        Pass
        {
            ...
            #include "InTerra_TerrainLit_Basemap.hlsl"
