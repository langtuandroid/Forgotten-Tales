...
struct Varyings
{
    ...
    #if defined(_NORMALMAP) && !defined(ENABLE_TERRAIN_PERPIXEL_NORMAL) || defined(PARALLAX)
...
#endif
{
    ...
    float3 tangentViewDir = float3(0,0,0);
        ...
        SplatmapMix(IN.uvMainAndLM, IN.uvSplat01, IN.uvSplat23, IN.normal.xyz, tangentViewDir, IN.positionWS, splatControl, weight, mixedDiffuse, smoothness, metallic, occlusion, normalTS);
    #else
